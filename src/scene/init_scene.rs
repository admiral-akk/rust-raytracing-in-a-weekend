...
pub fn init_scene(world: &mut World, range: i32) {
    ...
    world.push(Object::new(
        Sphere::new(1000.0 * vector::DOWN, 1000.0),
    ...
    for a in -range..range {
        for b in -range..range {
            ...
            if choose_mat < 0.8 {
                ...
                world.push(Object::new(hit_box, Box::new(lambertian)));
            } else if choose_mat < 0.95 {
                // metal
                let albedo = Color::random_range(0.5, 1.0);
                let fuzz = rng.gen_range(0.0..=0.5);
                let metal = Metal::new(albedo, fuzz);
                world.push(Object::new(hit_box, Box::new(metal)));
            } else {
                // glass
                let dielectric = Dielectric::new(1.5);
                world.push(Object::new(hit_box, Box::new(dielectric)));
            }
        }
    }
    world.push(Object::new(
        Sphere::new(vector::UP, 1.0),
        Box::new(Dielectric::new(1.5)),
    ));
    world.push(Object::new(
        Sphere::new(4.0 * vector::LEFT + vector::UP, 1.0),
    ...
    world.push(Object::new(
        Sphere::new(4.0 * vector::RIGHT + vector::UP, 1.0),
        Box::new(Metal::new(
            Color {
                r: 0.7,
                g: 0.6,
